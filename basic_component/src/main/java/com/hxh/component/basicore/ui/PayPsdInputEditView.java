...
public class PayPsdInputEditView extends EditText {
    ...
    public PayPsdInputEditView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
...
//        super.onDraw(canvas);
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if (textLength == maxCount) {
            if(null != mListener)
            {
                mListener.onInputSuccess(getPasswordString());
    ...
    public interface onPasswordListener {
        void onInputSuccess(String pwd);

    }

    public void setmListener(onPasswordListener mListener) {
